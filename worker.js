...
if(u.pathname==="/health")return json({ok:true,version:"v10.2.4.1",service:"BTC ALT REGIME TRADER v10.2.4.1",market:"Upbit KRW",kv:!!env.SCALPER_KV,telegramConfigured:!!(env.TELEGRAM_BOT_TOKEN&&env.TELEGRAM_CHAT_ID),pinConfigured:!!env.PIN,externalContext:{publicMacro:true}});
...
return new Response("BTC ALT REGIME TRADER v10.2.4.1",{headers:cors});}};
